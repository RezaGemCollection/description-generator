...
// Mock the updateVariantsBulletPoint function to avoid Shopify API dependency
...
<ul>
  ...
  for (const scenario of scenarios) {
    ...
    try {
      const updatedHtml = updateVariantsBulletPoint(sampleHtml, scenario.variants);
  ...
  // Test the complete process with mock product data
  ...
  const updatedDescription = updateVariantsBulletPoint(mockProduct.body_html, formattedVariants);
  ...
  console.log('');
  console.log('🚀 When variants are updated in Shopify:');
  console.log('1. Webhook detects variant changes');
  console.log('2. System calls updateVariantsInDescription()');
  console.log('3. Only the variants bullet point is updated');
  console.log('4. Rest of the AI-generated content remains unchanged');
  console.log('5. Product description is updated in Shopify automatically');
}
